...
def show_menu(groups_svc: group_svc_import.GroupsService):
    while True:
        ...
        if choice == '1':
            ...
            channels_groups = groups_svc.get_groups(group_type=group_svc_import.GroupType.CHANNELS)
        ...
        if choice == '3':
            ...
            if helpers.user_confirmation():
                groups_svc.remove_low_quality_channels_from_all_groups()
        ...
        if choice == '4':
            ...
            if helpers.user_confirmation():
                groups_svc.remove_low_quality_channels_from_group(group=channels_groups[group_id])
                print()
